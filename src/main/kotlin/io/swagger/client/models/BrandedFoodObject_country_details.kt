 ...
 * @param englishSpeaking The number of countries where English is the country's primary language
 * @param nonEnglishSpeaking The number of countries where English is not the country's primary language
 */
data class BrandedFoodObjectCountryDetails (

    /* The number of countries where English is the country's primary language */
    val englishSpeaking: kotlin.Int? = null,
    /* The number of countries where English is not the country's primary language */
    val nonEnglishSpeaking: kotlin.Int? = null
) {
}